...
public class RandomizeObjects : MonoBehaviour
{
    ...
    [SerializeField] float localscaleMultiplierMin = 0.8f;
    ...
    void OnEnable()
    {
        transform.localRotation = Quaternion.Euler(Random.Range(localRotationMin.x, localRotationMax.x), Random.Range(localRotationMin.y, localRotationMax.y), Random.Range(localRotationMin.z, localRotationMax.x));
